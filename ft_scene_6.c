...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2015/10/09 13:51:16 by vroche            #+#    #+#             */
/*   Updated: 2015/10/09 14:02:05 by vroche           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "rtv1.h"

static void	ft_init_object_6_part2(t_env *env)
{
	t_object	*cylinder;
	t_object	*cone;
...
static void	ft_init_object_6(t_env *env)
{
	t_object	*sphere;
	t_object	*plan;
	t_object	*plan2;
	...
	ft_init_object_6_part2(env);
}

static void	ft_init_spot_6(t_env *env)
{
	t_spot	spot1;
...
{
	ft_init_object_6(env);
	ft_init_spot_6(env);
	ft_printf("One cylinder, one cone, one sphere, 2 plans and one spot\n");
}
